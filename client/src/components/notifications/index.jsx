          ...
          <div className="row mb-3 bordered p-2 mx-auto">
            ...
            <div className="col-sm-10 col-8 col-md-8 col-lg-10 pr-0">
              ...
              <div className="p-2 text-center text-lg-left">
                <button className="btn btn-sm btn-success mr-2 mb-2" type="button" title="Returned book"><i className="fa fa-check" /> <span className="hidden-xs-down">returned</span></button>
                <button
                  className="btn btn-sm btn-info mr-2 mb-2"
                  type="button"
                  title="Borrowed book">
                  <i className="fa fa-info" />
                  <span className="hidden-xs-down">borrowed</span>
                </button>
                <button
                  className="btn btn-sm btn-warning mr-2 mb-2"
                  type="button"
                  title="User has been surcharged">
