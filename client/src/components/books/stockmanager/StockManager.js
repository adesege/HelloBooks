            ...
            <div className="col-sm-6 col-md-6 col-lg-3 col-xs-12 mb-4" key={index}>
              <div className="row">
                ...
                <div className="col-sm-6 col-6 p-sm-0 align-self-center">
                  ...
                  <Link to="/books/stock-manager/show" className="card-link" data-toggle="tooltip" title="Edit book">
                    <i className="fa fa-pencil"></i>
                  </Link>
                  <a href="#top" className="card-link text-danger" data-toggle="tooltip" title="Delete">
