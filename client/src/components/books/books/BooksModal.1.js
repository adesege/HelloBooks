...
class BooksModal extends Component {
    state = {
      ...
      stock_record_date: this.props.book ? this.props.book.stock_record_date : '',
      isbn: this.props.book ? this.props.book.isbn : '',
      published_date: this.props.book ? this.props.book.published_date : '',
      author: this.props.book ? this.props.book.author : '',
      book_category_id: this.props.book ? this.props.book.book_category_id : '',
      isLoading: false,
      showCoverBook: false,
      imageSrc: '',
