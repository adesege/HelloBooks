      ...
      <div>
        ...
        <div className="footer pt-3 pb-4 mdb-color lighten-3">
          ...
          <div className="mt-2 text-center">
            <a className="icons-sm"><i className="fa fa-facebook white-text fa-lg"> </i></a>
            <a className="icons-sm"><i className="fa fa-twitter white-text fa-lg"> </i></a>
            <a className="icons-sm"><i className="fa fa-google-plus white-text fa-lg"> </i></a>
          </div>
