...
import ConnectedChangePassword, { ChangePassword } from 'components/homepage/ResetPassword/ChangePassword';
...
describe('# ChangePassword', () => {
  ...
  it('should render the connected component', () => {
    const connectedComponent = shallow(<ConnectedChangePassword {...props} store={store} />, context);
